...
from mypage.API.V1.schemas import (Create_History_Recommand_Request,
                                   Create_History_Repository_Request,
                                   Read_Reponse)
from mypage.models import Mypage
from mypage.services import (create_history_recocommand,
                             create_history_repository, read_history)
...
def create_user_history(request: HttpRequest, create_history_request: Create_History_Repository_Request) -> None:
...
def create_user_history(request: HttpRequest, create_history_request: Create_History_Recommand_Request) -> None:
    user = request.user.id
