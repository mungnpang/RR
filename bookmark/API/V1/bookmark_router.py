...
from bookmark.API.V1.schemas import (CreateBookmarkRequest,
                                     CreateBookmarkResponse,
                                     DeleteBookmarkRequest,
                                     DeleteBookmarkResponse,
                                     ReadBookmarkResponse)
from bookmark.models import Bookmark
from bookmark.services import (create_bookmark, delete_bookmark, read_bookmark,
                               read_get_bookmark)
...
def bookmark_create(request: HttpRequest, create_bookmark_request: CreateBookmarkRequest) -> dict:
    user = request.user.id
...
def bookmark_delete(request: HttpRequest, delete_bookmark_request: DeleteBookmarkRequest) -> dict:
    user = request.user.id
    try:
